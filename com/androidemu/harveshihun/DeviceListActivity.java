...
public class DeviceListActivity extends Activity {
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() { // from class: com.androidemu.harveshihun.DeviceListActivity.1
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() { // from class: com.androidemu.harveshihun.DeviceListActivity.2
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setResult(0);
        ((Button) findViewById(R.id.button_scan)).setOnClickListener(new View.OnClickListener() { // from class: com.androidemu.harveshihun.DeviceListActivity.3
